    ...
    return (
        <div className="py-8 px-8 font-sans">
            <div className="text-center mb-8">
                ...
                <h3 className="text-xl">B.Tech 6th Semester Minor Project-II Synopsis</h3>
            ...
            <div className="my-8 flex flex-col gap-2">
                ...
                <p><strong>Type of Project:</strong> {data.typeOfProject}</p>
                <p><strong>Software Requirement:</strong> {data.softwareRequirement}</p>
                <p><strong>Hardware Requirement:</strong> {data.hardwareRequirement}</p>
            </div>
            <div className="border h-20 border-black text-left px-2">
                <p><strong>For Departmental/Official Use</strong></p>
            </div>
