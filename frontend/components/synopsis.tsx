...
const formSchema = z.object({
  ...
  problemStatement: z.string().refine(
    (value) => {
      const wordCount = value.trim().split(/\s+/).length;
      return wordCount >= 15;
    },
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>WHAT ARE YOU CALLING IT?</FormDescription>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    WRITE A SHORT, SHARP AND ON POINT DESCRIPTION OF YOUR
                    PROJECT
                  </FormDescription>
                  <FormControl>
                    <Textarea
                      placeholder=""
                      className="resize-none text-wrap h-24"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    DESCRIBE WHAT CAN PEOPLE USE IT FOR, OR HOW IT MAKES
                    EXISTING TASKS EASIER/SAFER
                  </FormDescription>
                  <FormControl>
                    <Textarea
                      placeholder=""
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>ADD GITHUB REPOSITORY LINK</FormDescription>
                  <FormControl>
                ...
                <FormItem>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="softwareHardware">
                        Software + Hardware
                      </SelectItem>
                    </SelectContent>
                  </Select>
