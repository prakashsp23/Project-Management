        ...
        >
          {hoveredIndex === item.id && (
            <motion.div
              ...
              className="absolute -top-16 -left-1/2 translate-x-1/2 flex text-xs  flex-col items-center justify-center rounded-md dark:bg-black bg-white z-50 shadow-xl px-4 py-2"
            >
